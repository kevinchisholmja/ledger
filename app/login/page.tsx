          ...
          {sent ? (
            <div className="rounded-2xl bg-zinc-900 border border-zinc-800 p-8 text-center">
              ...
              <button
                ...
                className="mt-6 text-xs text-zinc-500 hover:text-zinc-400 transition-colors cursor-pointer"
              >
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 rounded-xl bg-white hover:bg-zinc-50 active:bg-zinc-100 disabled:opacity-50 disabled:cursor-not-allowed px-4 py-3 text-sm font-semibold text-zinc-900 transition-colors shadow-sm cursor-pointer"
              >
                {googleLoading ? (
              ...
              <form onSubmit={handleMagicLink} className="space-y-3">
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed px-4 py-3 text-sm font-medium text-zinc-300 transition-colors cursor-pointer"
                >
